...
class AdapterSorting(mobiles: ArrayList<Mobile>, private val mContext: Context, @param:FragmentSortingMain.FragmentType @field:FragmentSortingMain.FragmentType
private val type: Int, private val itemClickListener: ItemClickListener?) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private val mobiles: ArrayList<Mobile>?

    init {
        this.mobiles = ArrayList(mobiles)
    }
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        val holder = viewHolder as ViewHolderList
    ...
    fun getItemAt(position: Int): Mobile? {
        return if (mobiles != null && mobiles.size > position) mobiles[position] else null
    }
