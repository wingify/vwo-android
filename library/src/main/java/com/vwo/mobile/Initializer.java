...
public class Initializer {
     ...
     * <p>
     * This method will initialize the SDK either by fetching data from server or from data of
     * previous launch or from defaults(in case of network failure)
     * </p>
     *
     * @param statusListener is the listener for receiving callback launch status update. i.e.
     *                       Failure or success.
     */
    ...
    public void launch(@Nullable VWOStatusListener statusListener) {
        if (statusListener != null) {
            if (vwo.getConfig() == null) {
                VWOConfig vwoConfig = new VWOConfig.Builder().setVWOStatusListener(statusListener)
                        .build();
    ...
    private void setup(@Nullable Long timeout) {
        if (this.vwo.getConfig() == null) {
            VWOConfig vwoConfig = new VWOConfig.Builder().apiKey(apiKey)
